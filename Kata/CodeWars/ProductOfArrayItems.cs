...
namespace Kata.CodeWars
{
	...
	///     If the array is null, you should throw ArgumentNullException and if the array is empty, you should throw
	///     InvalidOperationException.
	///     As a challenge, try writing your method in just one line of code. It's possible to have only 36 characters within
	///     your method.
	...
	public class ProductOfArrayItems
	{
		public int Product(int[] values)
		{
			...
			var result = 1;
			foreach (var item in values) result *= item;
